...
os.system('cls')
mixer.init()
mixer.music.load('C:\\Users\\Leandro\\Desktop\\Python\\A lenda\\Cobblestone Village.mp3')
...
if pular99 == 1:
    ...
    if pular1 == 1:
        mixer.music.pause()
        mixer.init()
        mixer.music.load('C:\\Users\\Leandro\\Desktop\\Python\\A lenda\\Musica de Batalha RPG Parte 1.mp3')
        mixer.music.play(loops=1000, start=0.0)
        print('----------')
        print('FASE 01:')
        print('----------')
